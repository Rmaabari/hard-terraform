...
vpc_id              = "vpc-08d81957b895e2ccd"
core_priv_subnet_id = "subnet-0bdfdb29f4f5a65a5"
engines_priv_subnet_id = "subnet-037067efbdd9c185e"
core_priv_route_table_id = "rtb-02014e431cc73857b"
# Replace the following placeholder IDs with real subnet IDs
entry_pub_subnet_id   = "subnet-013b5b45216a6413d"
...
cidr_vpc_block     = "10.96.20.0/22"


entry_pub_subnet = {
  cidr_block         = "10.96.20.128/25"
  cidr_reserved_block = "10.96.20.240/29"
  tag                = "entry_subnet"
}

engines_priv_subnet = {
  cidr_block = "10.96.22.128/25"
  internet   = "disabled"
  tag        = "engines_priv_subnet"
}

core_priv_subnet = {
  cidr_block         = "10.96.21.128/25"
  cidr_reserved_block = "10.96.21.240/29"
  internet           = "disabled"
  tag                = "core_subnet"
}
